...
| `dot upgrade [--yes]` | Update, optionally upgrade Homebrew, reinstall any cask whose linked artifacts are missing, upgrade Bun itself, then update Pi and its packages |
